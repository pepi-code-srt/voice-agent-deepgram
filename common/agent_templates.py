...
class AgentTemplates:
    def __init__(
        ...
        self.first_message = ""
        self.capabilities = ""
        self.custom_prompt = system_prompt  # Store custom prompt

        self.industry = industry

        self.voice_agent_url = VOICE_AGENT_URL
        # Use deepcopy to prevent shared state between agent instances
        ...
        # If custom system prompt is provided, use it instead of industry defaults
        if self.custom_prompt:
            self.company = "AI Assistant"
            self.personality = self.custom_prompt
            self.capabilities = "I can help you with various tasks."
